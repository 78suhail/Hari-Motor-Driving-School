      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        >
          {instructors.map((inst, idx) => (
            <SwiperSlide key={idx}>
              <div className="bg-white rounded-2xl shadow-lg flex flex-col items-center w-full max-w-xs mx-auto p-6 relative group transition-all duration-300 border-2 border-gray-200 hover:border-blue-500">
                <div className="w-full aspect-square rounded-xl overflow-hidden mb-4 relative group/image">
                  <img
                    src={inst.image}
                    alt={inst.name}
                    className="w-full h-full object-cover object-center transition-transform duration-300 group-hover/image:scale-110"
                  />
                  {/* Socials */}
                  <div className="absolute top-1/2 right-0 -translate-y-1/2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 pr-2">
